...
# 残り時間が0ならエフェクト削除
    execute unless data storage little_brewer: temp{zero_check:0} run data modify storage little_brewer: temp.active_effects append from storage little_brewer: temp.active_effects[0]
